	...
	await esbuild.build({
		...
		plugins: [
			alias({
				...
				"./helpers/test-utils.mjs": fileURLToPath(
					new URL("test-utils-deno.mjs", import.meta.url),
				),
				"../dist/main.node-es.mjs": fileURLToPath(
					new URL("../../dist/main.browser-es.mjs", import.meta.url),
				),
...
if (testedPlatform === "node") {
	await new Promise((resolve) => {
		const subprocess = cp.spawn(
			"npx",
			["ava", "--", path.join(buildDir, "*.js"), ...extraArguments],
			{
				stdio: "inherit",
